...
bool GraphSlamOptimizerG2O::addPrior(Node& node)
{
    ...
    tf::Matrix3x3 tf3d;
    tf3d.setValue(static_cast<double>(node.prior_pose(0,0)), static_cast<double>(node.prior_pose(0,1)), static_cast<double>(node.prior_pose(0,2)), 
        static_cast<double>(node.prior_pose(1,0)), static_cast<double>(node.prior_pose(1,1)), static_cast<double>(node.prior_pose(1,2)), 
        static_cast<double>(node.prior_pose(2,0)), static_cast<double>(node.prior_pose(2,1)), static_cast<double>(node.prior_pose(2,2)));
    tf::Quaternion qfin;
