...
public:
	ScanRegistration(double init_leaf_size, double icp_distance_max, double trans, double rot): course_scale_initial_leaf_size(init_leaf_size), course_scale_icp_distance_max(init_leaf_size), icp_trans_threshold(trans), icp_rot_threshold(rot){}
	void setup();
