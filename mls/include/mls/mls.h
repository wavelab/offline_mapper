...
class MLS {  
    ...
    double cluster_sigma_factor; //Gassian std dev to correspond a point to a cluster
    double cluster_dist_threshold; //additional delta offset from the sigma_factor
            ...
            drivabilityGrid(new nav_msgs::OccupancyGrid)
    {
        ...
        elevationGrid.setGeometry(grid_map::Length(size_x_meters, size_y_meters), res);
    ...
    //setters
    void setThicknessTheshold(double thickness_thresh) { thickness_threshold = thickness_thresh; }
