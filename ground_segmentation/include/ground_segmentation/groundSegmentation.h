...
public:
  ...
  // for GP model
  double P_L;  // length parameter, so how close the points have to be in the GP
               // model to consider them correlated
  ...
  Eigen::MatrixXd genGPModel(vector<signalPoint> &, vector<signalPoint> &,
                             float, float);
