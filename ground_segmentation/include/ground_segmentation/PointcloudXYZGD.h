...
#ifndef POINTCLOUDXYZGD_H
#define POINTCLOUDXYZGD_H
...
POINT_CLOUD_REGISTER_POINT_STRUCT(PointXYZGD,
                                  (float, x, x)(float, y, y)(float, z, z)(
                                      uint16_t, ground_adj,
                                      ground_adj)(uint16_t, drivable, drivable))

// Helper functions
inline bool isDR(float in) { return (in > 0.7); }

inline bool isGA(float in) { return (in > 0.5); }
